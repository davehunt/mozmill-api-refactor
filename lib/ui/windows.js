...
ModalDialogObserver.prototype.observe = function ModalDialogObserver_observe() {
  ...
  if (win && ("documentLoaded" in win)) {
    try {
      this._callback(new ChromeWindowWrapper(win));
    }
    catch (ex) {
 ...
 * Set our default values for our internal properties
 */
ChromeWindowWrapper.prototype._window = null;
 ...
 */
ChromeWindowWrapper.prototype.__defineGetter__("closed", function ChromeWindowWrapper_getClosed() {
 ...
 */
ChromeWindowWrapper.prototype.__defineGetter__("innerWindow", function Window_WrappergetInnerWindow() {
  return this._window;
});
 ...
 */
ChromeWindowWrapper.prototype.close = function ChromeWindowWrapper_close() {
  if (!this.closed) {
 ...
 */
ChromeWindowWrapper.prototype.keypress = function ChromeWindowWrapper_keypress(aKeyCode, aModifiers) {
 ...
 */
ChromeWindowWrapper.prototype.addEventListener = function ChromeWindowWrapper_addEventListener(aType, aListener,
                                                                                   aUseCapture,
                                                                                   aWantsUntrusted) {
 ...
 */
ChromeWindowWrapper.prototype.removeEventListener = function ChromeWindowWrapper_removeEventListener(aType, aListener,
                                                                                   aUseCapture) {
 ...
 *        open.
 *
 * @returns {ChromeWindowWrapper} The window if no callback has been specified.
 */
...
function ChromeWindowWrapper_handleWindow(aFilterCallback, aFilterValue,
  ...
  try {
    ...
    win = new ChromeWindowWrapper(win);
 ...
 *        The callback handler to interact with the modal dialog.
 */
ChromeWindowWrapper.prototype.initModalDialog =
function ChromeWindowWrapper_initModalDialog(aCallback) {
 ...
 */
ChromeWindowWrapper.prototype.mixin = function ChromeWindowWrapper_mixin(aMixinClass) {
