...
var BrowserMixin = {
  ...
  get ui() {
    if (!this._browser_ui)
      this._browser_ui = new BrowserUI(this.innerWindow.document);
    return this._browser_ui;
  },
  ...
  */
   ...
   */
  waitForPageLoad: function Browser_waitForPageLoad(aDocument, aTimeout, aInterval) {
   ...
   * Closes a single tab
   */
  closeTab: function Browser_closeTab() {
   ...
   */
  resetTabs: function Browser_resetTabs() {
