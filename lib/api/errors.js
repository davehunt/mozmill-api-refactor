...
function constructError(aClassName) {
  var constructor = function(aMessage, aFileName, aLineNumber, aFunction) {
    ...
    this.message = aMessage === undefined ? error.aMessage : aMessage;
    this.fileName = aFileName === undefined ? error.fileName : aFileName;
    this.lineNumber = aLineNumber === undefined ? error.lineNumber : aLineNumber;
    this.function = aFunction;
  }

  constructor.prototype.name = aClassName || Error.name;
...
/**
 * Custom error for unexpected behavior
 *
 * @class Unexpected behavior error
 * @memberOf errors
 * @param {String} aMessage Message to use for the error.
 * @param {String} aFileName Name of the file where the error occured.
 * @param {Number} aLineNumber Line number of the file where the error occured.
 * @param {String} aFunction Function in which the the error occured.
 */
errors.UnexpectedError = constructError("UnexpectedError");
