...
/**
 * Service to provide import and export of bookmarks in the Netscape Bookmarks HTML format.
 *
 * @see <a href="http://mxr.mozilla.org/mozilla-central/source/toolkit/components/places/nsIPlacesImportExportService.idl">nsIPlacesImportExportService</a>
 */
XPCOMUtils.defineLazyGetter(services, "importexport", function () {
  return Cc["@mozilla.org/browser/places/import-export-service;1"].
         getService(Ci.nsIPlacesImportExportService);
});

/**
 * Service to provide a set of URL parsing utility functions.
 *
 * @see <a href="http://mxr.mozilla.org/mozilla-central/source/netwerk/base/public/nsIIOService.idl">nsIIOService</a>
 */
XPCOMUtils.defineLazyGetter(services, "io", function () {
